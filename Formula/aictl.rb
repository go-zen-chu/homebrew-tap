class Aictl < Formula
    ...
    on_macos do
        if Hardware::CPU.arm?
            url "https://github.com/go-zen-chu/aictl/releases/download/v1.0.3/aictl_Darwin_arm64.tar.gz"
            sha256 "cab0c349bcacddb719fd30af36a39ca91704fefe1efb8e05d17d726c66400afd"
        else
            url "https://github.com/go-zen-chu/aictl/releases/download/v1.0.3/aictl_Darwin_x86_64.tar.gz"
